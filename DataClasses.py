...
# KBloodsworth, 2022-Mar-27, Completed TODO's
#------------------------------------------#
...
class Track():
    ...
    # -- Constructor -- #
    def __init__(self, t_position, t_title, t_length):
        self.__t_position = int(t_position)
    ...
    @property
    def t_position(self):
        return self.__t_position
    
    @t_position.setter
    def t_position(self, value):
        try:
            self.__t_position = int(value)
        except Exception:
            raise Exception('Track position needs to be an integer.')
    ...
    def t_length(self, value):
        try:
            ...
            raise Exception('Track length need to be a string.')
    ...
    def __str__(self):
        ...
        return '{:>2}. {} ({})'.format(self.t_position, self.t_title, self.t_length)

    def get_record(self) -> str:
        """Returns: Track record formatted for saving to file"""
        return '{},{},{}'.format(self.t_position, self.t_title, self.t_length)
...
class CD:
    ...
    def add_track(self, track: Track) -> None:
        ...
        # This appends the track to the list of tracks.
        self.__tracks.append(track)
        
        # TODone sort tracks
        
        #Sorts tracks after track appendedd to list. 
        self.__sort_tracks()
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        for track in self.__tracks:
            if track.t_position == track_id:
                self.track.remove(track)
                print('Track at position ' + str(track_id), 'has been removed.')
