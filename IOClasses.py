...
class FileIO:
    ...
    def save_inventory(file_name: list, lst_Inventory: list) -> None:
        ...
        # I couldn't get this to work and ended up look at the appendix for help. 
        file_name_CD = file_name[0]
        file_name_cd_tracks = file_name[1]
        try:
            ...
            with open(file_name_cd_tracks, 'w') as file:
                for disc in lst_Inventory:
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            with open(file_name_cd_tracks, 'r') as file:
                data = line.strip().split(',')
